...
using MIS333K_FinalProject.Utilities;
using System;
...
namespace MIS333K_FinalProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel rvm)
        {
            ...
            var age = today.Year - rvm.Birthday.Year;

            // If the birthday hasn't occurred yet this year, subtract 1 from the age
            if (rvm.Birthday > today.AddYears(-age))
            {
                age--;
            }
            ...
            if (age < 18)
            {
                ModelState.AddModelError("Birthday", "You must be at least 18 years of age to register.");
