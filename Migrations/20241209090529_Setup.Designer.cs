...
namespace MIS333K_FinalProject.Migrations
{
    ...
    [Migration("20241209090529_Setup")]
    partial class Setup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MIS333K_FinalProject.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("MIS333K_FinalProject.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("MIS333K_FinalProject.Models.Property", b =>
                {
            ...
            modelBuilder.Entity("MIS333K_FinalProject.Models.Reservation", b =>
                {
            ...
            modelBuilder.Entity("MIS333K_FinalProject.Models.Review", b =>
                {
            ...
            modelBuilder.Entity("MIS333K_FinalProject.Models.Unavailability", b =>
                {
            ...
            modelBuilder.Entity("MIS333K_FinalProject.Models.Property", b =>
                {
                    b.HasOne("MIS333K_FinalProject.Models.Category", "Category")
                        .WithMany("Properties")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MIS333K_FinalProject.Models.AppUser", "Host")
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("MIS333K_FinalProject.Models.Reservation", b =>
                {
                    b.HasOne("MIS333K_FinalProject.Models.AppUser", "Customer")
                        .WithMany("Reservations")
                        .HasForeignKey("CustomerId");

                    b.HasOne("MIS333K_FinalProject.Models.Property", "Property")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MIS333K_FinalProject.Models.AppUser", null)
                        .WithMany()
